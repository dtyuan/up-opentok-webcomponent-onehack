...
(function () {
  ...
  var _setupUI = function () {
    ...
    var parent = _this.options.textChatContainer;

    console.log("_setupUI", parent, _this.options.textChatContainer);
    ...
    chatView.querySelector('#sendMessage').onclick = function () {
      _sendTxtMessage(_composer.value);
    };
    // Add INITIALIZE success log event
